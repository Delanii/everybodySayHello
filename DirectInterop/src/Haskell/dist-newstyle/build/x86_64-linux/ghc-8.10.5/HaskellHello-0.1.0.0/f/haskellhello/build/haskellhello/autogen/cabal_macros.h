...
/* package HaskellHello-0.1.0.0 */
#ifndef VERSION_HaskellHello
#define VERSION_HaskellHello "0.1.0.0"
#endif /* VERSION_HaskellHello */
#ifndef MIN_VERSION_HaskellHello
#define MIN_VERSION_HaskellHello(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskellHello */
...
#define CURRENT_COMPONENT_ID "HaskellHello-0.1.0.0-inplace-haskellhello"
